...
const CompanyEditPage = async ({ params }: { params: { companyId: string } }) => {
  ...
  const requiredFields = [company.name, company.description, company.logo, company.coverImage, company.mail, company.website, company.linkedin, company.addres_line_1, company.city, company.state, company.overview, company.whyJoinUS];
